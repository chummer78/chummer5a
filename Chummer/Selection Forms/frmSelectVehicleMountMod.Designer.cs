namespace Chummer
{
	partial class frmSelectVehicleMountMod
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmSelectVehicleMountMod";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Tag = "Title_SelectVehicleMountMod";
			this.Text = "Select a Vehicle Modification";
			this.Load += new System.EventHandler(this.frmSelectVehicleMountMod_Load);
